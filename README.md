...
🌐 [Live App](https://www.recall.ltd) · [Issues](https://github.com/adityakamble49/Recall/issues)
...
| 3 | **Get Contents of URL** | URL: `https://www.recall.ltd/api/bookmarks` — Method: POST — Header: `Authorization: Bearer <Text>` — Body (JSON): `url` = Shortcut Input, `title` = Shortcut Input |
